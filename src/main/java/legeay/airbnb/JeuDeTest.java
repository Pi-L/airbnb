...
public class JeuDeTest {
    ...
    private static final String[] listeDateDeReservation = {"12/04/2021","28/01/2020", "15/01/2020", "21/01/2020", "15/06/2021","01/01/2041","31/12/2021","28/07/2025","01/11/2022","31/04/2021"};
    ...
    public JeuDeTest(int nbSejours) throws ParseException {
        ...
        for (int i = 0; i < nbSejours; i++) {
            ...
            Date dateArrivee = new MaDate(getListeDateDeReservation());
